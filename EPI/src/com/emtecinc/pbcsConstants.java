...
public class pbcsConstants {
    ...
    public static final String DBG_PBCS_PASS = "Emtec2016!";
    public static final String DBG_PBCS_HPVER = "v3";
    ...
    public static final String EVT_COLUMN_VALUES = "Column Values";
